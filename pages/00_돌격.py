...
<style>
    ...
    h1, h2, h3 { font-family: 'Teko', 'Noto Sans KR', sans-serif !important; font-style: italic; font-weight: 900 !important; color: #4EA8DE !important; text-shadow: 0 0 10px rgba(78,168,222,0.5); }
    ...
    .dark-table th { background-color: #4EA8DE; color: #1b1c23; padding: 12px; font-weight: 900; font-size: 1.5rem; font-style: italic; }
...
for _, row in tank_df.iterrows():
    fig_scatter.add_layout_image(
        dict(
            ...
            xref="x", yref="y", sizex=1.5, sizey=1.5, 
