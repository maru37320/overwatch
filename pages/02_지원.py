...
<style>
    ...
    h1, h2, h3 { font-family: 'Teko', 'Noto Sans KR', sans-serif !important; font-style: italic; font-weight: 900 !important; color: #38E09E !important; text-shadow: 0 0 10px rgba(56,224,158,0.5); }
    ...
    .dark-table th { background-color: #38E09E; color: #1b1c23; padding: 12px; font-weight: 900; font-size: 1.5rem; font-style: italic; }
...
for _, row in sup_df.iterrows():
    fig_scatter.add_layout_image(
        dict(
            ...
            xref="x", yref="y", sizex=4.0, sizey=2.0, 
