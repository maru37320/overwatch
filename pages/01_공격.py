...
st.set_page_config(page_title="DAMAGE HEROES", page_icon="⚔️", layout="wide")
...
st.title("⚔️ DAMAGE HERO ANALYSIS")
...
with col1:
    ...
    fig_pick = px.bar(
        ...
        color_discrete_sequence=["#F4556C"]
    )
...
with col2:
    ...
    fig_scatter = px.scatter(
        dmg_df, x='픽률(%)', y='승률(%)', size='픽률(%)', hover_name='영웅',
        color_discrete_sequence=["#F4556C"]
    )
